...
class UpdatePerson(Toplevel):
    def __init__(self, person_id):
        ...
        # button
        self.btn = Button(self.bottom, width=12, text="Add person", command=self.update_current_person)
        self.btn.place(x=270, y=420)

    def update_current_person(self):
        id = self.person_id
        ...
        query = " update addressbook set person_name = '{}', person_surname = '{}', person_email = '{}'," \
                " person_phone = '{}',person_address = '{}' where person_id = '{}'".format(
